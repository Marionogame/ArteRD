...
const createProductoHandler = async (request, h) => {
    try {
        const { nombre,
            categoria, descripcion, precio, estado_venta, fecha_creacion, medida_alto,
            medida_ancho, imagen, id_usuario, estilo, tecnica, soporte} = request.payload;
        const producto = await Models.Productos.create({
            nombre:nombre, categoria:categoria, descripcion:descripcion , precio:precio, estado_venta:estado_venta,
...
const updateProductoHandler = async (request, h) => {
    try {
        ...
        const {  nombre, categoria, descripcion, precio, estado_venta, fecha_creacion, medida_alto,
            medida_ancho, imagen,id_usuario, estilo,
            tecnica,
            soporte  } = request.payload;
...
module.exports = [
    ...
    { method: 'POST', path: '/producto', config: {
        validate: {
        payload: Joi.object({
    ...
    { method: 'PUT', path: '/producto/{id}', config: {
        validate: {
        payload: Joi.object({
