...
function Page(props) {
  ...
  var contador = -1;
    ...
    return (
        <Fragment>
            ...
            LoginDatos={LoginDatos}imagen={imagen}EliminarImagenAnterior={EliminarImagenAnterior}datosLoginOnline={datosLoginOnline}NavRegister={NavRegister}buscarImagenPerfil={buscarImagenPerfil}/>
            </div>
  ...
  <ul className="pagination justify-content-start">
    <li className="page-item disabled">
      <span className="page-link"  tabIndex="-1"  id="pagItem" >Previous</span>
    </li>
    ...
    <li className="page-item" >
      <span className="page-link" id="pagItem">Next</span>
    </li>
  </ul>
</nav>
  ...
  <div className="card"  key={buscarImagen}  id="transicion" >
    <img className="card-img-top embed-responsive-item" src={buscarImagen}  alt="Arte Imagen" ></img>
